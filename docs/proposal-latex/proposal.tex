...
%%%%%%%%% TITLE
\title{Equity Market Technical Analysis using Machine Learning Proposal}

\author{Shawn Cicoria\\
{\tt\small Shawn.cicoria@microsoft.com}
\and
David Apolinar\\
{\tt\small david.apolinar@microsoft.com}
\and
Ted Moore\\
{\tt\small tmxxxx@njit.edu}
}
